	...
	void __attribute__((__interrupt__)) _T2Interrupt( void )
{
	...
	sin_index1++;
	if (sin_index1==SAMPLE)sin_index1=0;
	sin_index2++;
	if (sin_index2==SAMPLE)sin_index2=0;
	sin_index3++;
	if (sin_index3==SAMPLE)sin_index3=0;
	sin_index4++;
	if (sin_index4==SAMPLE)sin_index4=0;
	sin_prescaler=0;
	}
	else sin_prescaler++;
}
...
// Initialize Timer3
	...
	IPC1bits.T3IP = 0x01; // Set Timer 3 Interrupt Priority Level

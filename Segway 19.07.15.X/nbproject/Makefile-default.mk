...
${OBJECTDIR}/Pid_c.o: Pid_c.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  Pid_c.c  -o ${OBJECTDIR}/Pid_c.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Pid_c.o.d"      -g -D__DEBUG     -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/SpeedCurve.o: SpeedCurve.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  SpeedCurve.c  -o ${OBJECTDIR}/SpeedCurve.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/SpeedCurve.o.d"      -g -D__DEBUG     -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/Pid_s.o: Pid_s.s  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_AS_PRE)  Pid_s.s  -o ${OBJECTDIR}/Pid_s.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG   -omf=elf -Wa,-MD,"${OBJECTDIR}/Pid_s.o.d",--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,,-g,--no-relax$(MP_EXTRA_AS_POST)
...
dist/${CND_CONF}/${IMAGE_TYPE}/Segway_19.07.15.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Segway_19.07.15.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG   -omf=elf     -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
